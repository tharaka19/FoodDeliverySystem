...
<html style="font-size: 16px;">
  <head>
    ...
    <link rel="stylesheet" href="resources/admin/css/My-Account.css" media="screen">
   ...
   function getAllShippingDetails() {
		var data = "";
				$.ajax({
						type : "POST",
						url : "MyAccount/getAllShippingDetails",
						data : {
   ...
   function saveShippingDetails() {
	   ...
	   if($("#AddressfirstName").val() == "" || $("#AddresslastName").val() == "" ||  $("#houseNoOrLane").val() == "" || $("#streetName").val() == "" || $("#city").val() == ""){
			...
			$.ajax({
				type : "POST",
				url : "MyAccount/saveShippingDetails",
				data : {
  ...
  <body class="u-body u-overlap u-overlap-contrast"><header class=" u-clearfix u-header u-section-row-container" id="sec-8947"><div class="u-section-rows" style="margin-bottom: 0px;">
    ...
    <section class="skrollable u-clearfix u-image u-parallax u-section-1" id="sec-f831" data-image-width="1280" data-image-height="853">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-custom-color-2 u-text-default u-text-1"><span class="u-icon u-icon-1"><svg class="u-svg-content" viewBox="0 0 55 55" x="0px" y="0px" style="width: 1em; height: 1em;"><path d="M55,27.5C55,12.337,42.663,0,27.5,0S0,12.337,0,27.5c0,8.009,3.444,15.228,8.926,20.258l-0.026,0.023l0.892,0.752
	c0.058,0.049,0.121,0.089,0.179,0.137c0.474,0.393,0.965,0.766,1.465,1.127c0.162,0.117,0.324,0.234,0.489,0.348
	c0.534,0.368,1.082,0.717,1.642,1.048c0.122,0.072,0.245,0.142,0.368,0.212c0.613,0.349,1.239,0.678,1.88,0.98
	c0.047,0.022,0.095,0.042,0.142,0.064c2.089,0.971,4.319,1.684,6.651,2.105c0.061,0.011,0.122,0.022,0.184,0.033
	c0.724,0.125,1.456,0.225,2.197,0.292c0.09,0.008,0.18,0.013,0.271,0.021C25.998,54.961,26.744,55,27.5,55
	...
	s-7.024,1.065-8.867,3.168c-2.119,2.416-1.935,5.346-1.883,5.864v4.667c-0.568,0.661-0.887,1.502-0.887,2.369v3.545
	c0,1.101,0.494,2.128,1.34,2.821c0.81,3.173,2.477,5.575,3.093,6.389v2.894c0,0.816-0.445,1.566-1.162,1.958l-7.907,4.313
	c-0.252,0.137-0.502,0.297-0.752,0.476C5.276,41.792,2,35.022,2,27.5z"></path></svg><img></span>&nbsp;<span style="font-size: 3rem;">Welcome</span>,
        </h1>
        <h2 class="u-text u-text-custom-color-1 u-text-default u-text-2"><div id="fulName"><%out.print(customer.getFirstName() +" "+ customer.getLastName());%></div></h2>
      </div>
    </section>
    <section class="u-align-left u-clearfix u-white u-section-2" id="sec-70e5">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <div class="u-expanded-width u-tab-links-align-justify u-tabs u-tabs-1">
          <ul class="u-border-1 u-border-grey-75 u-spacing-30 u-tab-list u-unstyled" role="tablist">
            <li class="u-tab-item" role="presentation">
              <a class="active u-active-custom-color-2 u-button-style u-hover-palette-2-base u-tab-link u-text-active-black u-text-body-color u-text-hover-white u-tab-link-1" id="link-tab-081f" href="#tab-081f" role="tab" aria-controls="tab-081f" aria-selected="true"> Profile Edit</a>
            </li>
            <li class="u-tab-item" role="presentation">
              <a class="u-active-custom-color-2 u-button-style u-hover-palette-2-base u-tab-link u-text-active-black u-text-body-color u-text-hover-white u-tab-link-2" id="link-tab-4d57" href="#tab-4d57" role="tab" aria-controls="tab-4d57" aria-selected="false"> Shipping Details</a>
            </li>
            <li class="u-tab-item" role="presentation">
              <a class="u-active-custom-color-2 u-button-style u-hover-palette-2-base u-tab-link u-text-active-black u-text-body-color u-text-hover-white u-tab-link-3" id="link-tab-3a42" href="#tab-3a42" role="tab" aria-controls="tab-3a42" aria-selected="false"> Change Password</a>
            </li>
          ...
          <div class="u-tab-content">
														  ...
														  <div class="col"></div>
															<div class="col">
																<div class="mb-3">
																	...
																	<input type="text" class="form-control" required placeholder="First Name" name="id" id="id" value="<%out.print(customer.getId());%>"/>
																</div>
															</div>
															<div class="col"></div>
														</div>
														  ...
														  <div class="col"></div>
															<div class="col">
																<div class="mb-3">
																	...
																	<input type="text" class="form-control" required placeholder="First Name" name="firstName" id="firstName" value="<%out.print(customer.getFirstName());%>"/>
																</div>
															</div>
															<div class="col"></div>
														</div>
														  ...
														  <div class="col"></div>
															<div class="col">
																<div class="mb-3">
																	...
																	<input type="text" class="form-control" required placeholder="Last Name" name="lastName" id="lastName" value="<%out.print(customer.getLastName());%>"/>
																</div>
															</div>	
															<div class="col"></div>
														...
														<div class="row">
															...
															<div class="col">
																<div class="mb-3">
																	...
																	<div>
																		<input type="tel" class="form-control" required placeholder="Phone Number" name="phoneNumber" id="phoneNumber" pattern="/^\(?([0-9]{3})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$/" value="<%out.print(customer.getPhoneNumber());%>"/>
																	</div>
																</div>
															</div>
															<div class="col"></div>
													...
													<div class="row">
															...
															<div class="col">
																<div class="mt-3 text-end">
																	<button class="btn btn-success" type="submit" id="updateCustomerBtn" onclick="updateCustomer()">Update</button>
																</div>
															</div>
													</div>
            ...
            <div class="u-container-style u-tab-pane u-white u-tab-pane-2" id="tab-4d57" role="tabpanel" aria-labelledby="link-tab-4d57">
              <div class="u-container-layout u-valign-bottom u-container-layout-2">
                <div class="u-tab-links-align-justify u-tabs u-tabs-2">
                  <ul class="u-spacing-30 u-tab-list u-unstyled" role="tablist">
                    <li class="u-tab-item" role="presentation">
                      <a class="active u-border-2 u-border-active-palette-1-light-1 u-border-hover-palette-2-base u-button-style u-tab-link u-text-active-palette-1-light-1 u-text-hover-palette-2-base u-tab-link-6" id="link-tab-2afa" href="#tab-2afa" role="tab" aria-controls="tab-2afa" aria-selected="true">Shoping Details</a>
                    </li>
                    <li class="u-tab-item" role="presentation">
                      <a class="u-border-2 u-border-active-palette-1-light-1 u-border-hover-palette-2-base u-button-style u-tab-link u-text-active-palette-1-light-1 u-text-hover-palette-2-base u-tab-link-7" id="link-tab-8e37" href="#tab-8e37" role="tab" aria-controls="tab-8e37" aria-selected="false">Add New Address</a>
                    </li>
                  </ul>
                  <div class="u-tab-content">
                    <div class="u-align-left u-container-style u-tab-pane u-tab-pane-3" id="tab-2afa" role="tabpanel" aria-labelledby="link-tab-2afa">
                      <div class="u-container-layout u-container-layout-3">
                        <div class="u-table u-table-responsive u-table-1">
                          <table class="u-table-entity">
                            ...
                            <thead class="u-align-center u-palette-2-light-1 u-table-header u-table-header-1">
                              <tr style="height: 31px;">
                                <th class="u-table-cell">Full Name</th>
                                <th class="u-table-cell">Address</th>
                                <th class="u-table-cell">Status</th>
                                <th class="u-table-cell">Action</th>
                              </tr>
                            </thead>
                            <tbody class="u-align-center u-table-body" id="addressTable">
                    ...
                    <div class="u-container-style u-tab-pane u-tab-pane-4" id="tab-8e37" role="tabpanel" aria-labelledby="link-tab-8e37">
                      <div class="u-container-layout u-valign-top u-container-layout-4">
                        <br><br>
                        
                        <form class="custom-validation" id="addressForm" name="addressForm">
								...
								<div class="row">
														<div class="row">
														  <div class="col"></div>
															<div class="col">
																<div class="mb-3">
																	<input type="text" class="form-control" required placeholder="First Name" name="AddressfirstName" id="AddressfirstName"/>
																</div>
															</div>
															<div class="col"></div>
														</div>
														...
														<div class="row">
														  <div class="col"></div>
															<div class="col">
																<div class="mb-3">
																	<input type="text" class="form-control" required placeholder="Last Name" name="AddresslastName" id="AddresslastName" />
																</div>
															</div>	
															<div class="col"></div>
													...
													<div class="row">
															...
															<div class="col">
															<div class="square-switch">
																	<input type="checkbox" id="square-switch1" switch="none" / onclick="checkValue()" value="Off">
													...
													<div class="row">
															...
															<div class="col">
																<div class="mt-3 text-end">
																	<button class="btn btn-success" type="submit" id="saveShippingDetailsBtn" onclick="saveShippingDetails()">Save</button>
																</div>
															</div>
													</div>
            ...
            <div class="u-align-left u-container-style u-tab-pane u-white u-tab-pane-6" id="link-tab-d7e7" role="tabpanel" aria-labelledby="tab-d7e7">
