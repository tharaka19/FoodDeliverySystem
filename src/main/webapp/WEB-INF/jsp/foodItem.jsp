...
<head>
	...
	function getActiveCategory(name,id) {
		...
		var data = "";
				...
				$.ajax({
						type : "GET",
						url : "Category/getActiveCategory/"+ status,
									...
									if(data[i].status == "Active"){
										...
										.append(
												'<tr class="tr">'
														...
														+ '<td>  <input type="button" id="deactiveBtn" class="btn btn-outline-info waves-effect waves-light" onclick="deactiveFoodItem('+ data[i].id + ')" value="Deactive"></input></td>'
												        + '<td>  <input type="button" class="btn btn-outline-warning waves-effect waves-light" onclick="editFoodItem('+ data[i].id + ')" data-toggle="modal" data-target="#cart" value="Edit"></input></td>'
												        + '<td>  <input type="button" class="btn btn-outline-danger waves-effect waves-light" onclick="deleteFoodItem(' + data[i].id + ')" value="Delete"></input></td>'
												        + '</tr>');
										...
										.append(
												'<tr class="tr">'
														...
														+ '<td>  <input type="button" id="activeBtn" class="btn btn-outline-info waves-effect waves-light" onclick="activeFoodItem('+ data[i].id + ')" value="Active"></input></td>'
												        + '<td>  <input type="button" class="btn btn-outline-warning waves-effect waves-light" onclick="editFoodItem('+ data[i].id + ')" data-toggle="modal" data-target="#cart" value="Edit"></input></td>'
												        + '<td>  <input type="button" class="btn btn-outline-danger waves-effect waves-light" onclick="deleteFoodItem(' + data[i].id + ')" value="Delete"></input></td>'
												        + '</tr>');
	...
	function activeFoodItem(id) {
		
		$.ajax({
			type : "POST",
			url : "FoodItem/updateFoodItemStatus",
			data : {
								...
								<div class="card">
										...
										<div class="p-4">
											<div class="d-flex align-items-center">
												...
												<div class="flex-grow-1 overflow-hidden">
													<h5 class="font-size-16 mb-1">Add Food Item</h5>
									...
									<div id="addproduct-billinginfo-collapse" class="collapse show" data-bs-parent="#addproduct-accordion">
										<div class="p-4 border-top">
											<button type="button" class="btn btn-success waves-effect waves-light mb-3" data-toggle="modal" data-target="#cart" onclick="addNewFoodItemBtn()"><i class="mdi mdi-plus me-1"></i> Add New Food Item</button>
...
<!-- 															<button class="btn btn-success" type="button" onclick="getAllCategory()">Get</button>
 -->													<div class="row" id="categoryField">
														    <div class="col"></div>
															<div class="col">
																<div class="mb-3">
																	<label for="cars" class="form-label" for="validationCustom01">Category:</label>
																		 	<select class="form-control" id="categoryNameList" required>
													...
													<div class="row">
															...
															<div class="col">
																<div class="mb-3">
																	<label class="form-label" for="validationCustom04">Quantity</label>
														...
														<div class="row">
															...
															<div class="col">
																<div class="mb-3">
																	<label class="form-label" for="validationCustom06">Description </label>
														...
														<div class="row">
															...
															<div class="col text-end">
																	<button class="btn btn-success" type="submit" id="saveFoodItemBtn" onclick="saveFoodItem()">Save</button>
																	<button class="btn btn-success" type="submit" id="updateFoodItemBtn" onclick="updateFoodItem()">Update</button>
