...
<script>
  ...
  <body class="u-body u-overlap"><header class=" u-clearfix u-header u-section-row-container" id="sec-8947"><div class="u-section-rows" style="margin-bottom: 0px;">
    ...
    <section class="skrollable u-clearfix u-image u-parallax u-section-1" id="sec-745f" data-image-width="1280" data-image-height="853">
            ...
            <div class="u-layout-row">
              <div class="u-align-left u-container-style u-layout-cell u-left-cell u-size-22 u-layout-cell-1">
                <div class="u-container-layout u-container-layout-1">
                  <h1 class="u-text u-text-custom-color-2 u-text-default u-text-1"> Food Menu</h1>
                  <h2 class="u-text u-text-custom-color-1 u-text-default u-text-2">HOME / MENU</h2>
                </div>
              </div>
    ...
    <section class="u-clearfix u-section-2" id="sec-10ed">
    
     <!-- menu -->
     
 	  <div class="u-clearfix u-sheet u-sheet-1">
 	  
        <img class="u-image u-image-round u-radius-50 u-image-1" src="<spring:url value="/resources/siteImage/241421933_199027628984829_7800482722545335494_n.jpg"/>" alt="" data-image-width="1280" data-image-height="876" data-animation-name="rotateIn" data-animation-duration="1000" data-animation-delay="0" data-animation-direction="">
        <img class="u-image u-image-round u-radius-50 u-image-2" src="<spring:url value="/resources/siteImage/243248977_202718378615754_4167061881659520703_n.jpg"/>" alt="" data-image-width="1280" data-image-height="876" data-animation-name="rotateIn" data-animation-duration="1000" data-animation-delay="0" data-animation-direction="" >
      </div>
      
      <center>
              <a href="./FoodItemMenu" data-page-id="47550152" class="u-active-palette-2-base u-border-2 u-border-active-black u-border-custom-color-1 u-border-hover-black u-btn u-btn-round u-button-style u-hover-custom-color-1 u-none u-radius-50 u-text-black u-text-hover-black u-btn-1">View Food Item Menu</a>
              <a href="./PromoMenu" data-page-id="47550152" class="u-active-palette-2-base u-border-2 u-border-active-black u-border-custom-color-1 u-border-hover-black u-btn u-btn-round u-button-style u-hover-custom-color-1 u-none u-radius-50 u-text-black u-text-hover-black u-btn-1">View Promo Menu</a>
     </center>
       </section>
