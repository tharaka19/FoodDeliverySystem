...
<head>
	...
	function getTodayOrders(){
		...
		$.ajax({
				type : "POST",
				url : "AdminDashbord/Home/getTodayOrderDetails",
	...
	function getAllCustomer(){
		...
		$.ajax({
				type : "POST",
				url : "AdminDashbord/Home/getAllCustomer",
				success : function(response) {
					 data = response
	...
	function getTopSellingPromo(){
		...
		$.ajax({
				type : "POST",
				url : "AdminDashbord/Home/getTopSellingPromo",
				data : {
	...
	function getTopSellingFoodItems(){
		...
		if($("#categoryNameList").val() == ""){
			...
			$.ajax({
					type : "POST",
					url : "AdminDashbord/Home/getTopSellingFoodItems",
					data : {
			...
			<div data-simplebar class="sidebar-menu-scroll">
				...
				<div id="sidebar-menu">
					...
					<ul class="metismenu list-unstyled" id="side-menu">
						...
						<li>
							<a href="./AdminDashbord/Home"> <i class="uil-home-alt"></i><span class="badge rounded-pill bg-primary float-end">01</span> <span>Dashboard</span> </a>
						</li>
						...
						<li>
							<a href="./AdminDashbord/Customer" class="waves-effect"> <i class="uil-calender"></i> <span>Customers</span> </a>
						</li>
						<li>
							<a href="./AdminDashbord/Order" class="waves-effect"> <i class="uil-calender"></i> <span>Orders</span> </a>
						</li>
						<li>
							<a href="./AdminDashbord/Payment" class="waves-effect"> <i class="uil-calender"></i> <span>Payment</span> </a>
						</li>
						<li>
							<a href="./AdminDashbord/Income" class="waves-effect"> <i class="uil-calender"></i> <span>Income</span> </a>
						</li>
						<li>
							<a href="./AdminDashbord/Email" class="waves-effect"> <i class="uil-calender"></i> <span>Email</span> </a>
						</li>
						<li>
							...
							<ul class="sub-menu" aria-expanded="false">			
								...
								<li><a href="./AdminDashbord/DeliveryLocation">Delivery Location</a></li>
							</ul>
						</li>
