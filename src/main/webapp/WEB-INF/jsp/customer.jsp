...
<head>
								...
								for (i = 0; i < data.length; i++) {
										...
										.append(
												'<tr class="tr">'
												        ...
												        + '<td>  <input type="button" class="btn btn-outline-secondary waves-effect" onclick="getAllCustomerShippingDetails(' + data[i].id + ')" data-toggle="modal" data-target="#customerCart" value="View"></input></td>'
												        + '<td>  <input type="button" class="btn btn-outline-danger waves-effect waves-light" onclick="deleteCustomer(' + data[i].id + ')" value="Delete"></input></td>'
												        + '</tr>');
	...
	function getAllCustomerShippingDetails(id){
		
		$.ajax({
			type : "POST",
			url : "Customer/getAllCustomerShippingDetails",
			data : {
				...
				for (i = 0; i < data.length; i++) {
					...
					if(data[i].status == "On"){
						...
						.append(
								...
								+ '<div class="card-body">'
								+ '<h5 class="font-size-14 mb-4">Address ' + number + '</h5>'
						...
						.append(
								...
								+ '<p class="mb-1">' + data[i].houseNoOrLane + ',<br>'+ data[i].streetName + ',<br>' + data[i].city + '</p>'
								+ '<div class="square-switch">'
								+ '<div id="activeLable" class="badge bg-pill bg-soft-danger font-size-12">'+ data[i].status +'</div>'
								+ '</div></div></div></div>');
					}
										...
										<div class="p-4">
											<div class="d-flex align-items-center">
												...
												<div class="flex-grow-1 overflow-hidden">
													<h5 class="font-size-16 mb-1">Customer Details</h5>
												</div>
									...
									<a href="<spring:url value="#addproduct-metadata-collapse"/>" class="text-dark collapsed" data-bs-toggle="collapse" aria-haspopup="true" aria-expanded="false" aria-haspopup="true" aria-controls="addproduct-metadata-collapse">
										<div class="p-4">
											<div class="d-flex align-items-center">
												...
												<div class="flex-grow-1 overflow-hidden">
													<h5 class="font-size-16 mb-1">Customer Info</h5>
