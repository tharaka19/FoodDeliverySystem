...
<html style="font-size: 16px;">
  <head>
	...
	<link rel="stylesheet" id="app-style" href="<spring:url value="/resources/css/app.min.css"/> ">
     ...
     <link rel="stylesheet" href="<spring:url value="resources/admin/css/Shoping-Cart.css"/> ">
     <link rel="stylesheet" href="<spring:url value="/resources/admin/css/cart.css"/> ">
    ...
    <meta name="twitter:title" content="Shoping Cart">
...
$(document).ready(function() {
  ...
  <body class="u-body u-overlap"><header class=" u-clearfix u-header u-section-row-container" id="sec-8947"><div class="u-section-rows" style="margin-bottom: 0px;">
	...
	c-0.252,0.137-0.502,0.297-0.752,0.476C5.276,41.792,2,35.022,2,27.5z"></path></svg><img></span>&nbsp;<span style="font-size: 3rem;">Welcome</span>,
        ...
        <h2 class="u-text u-text-custom-color-1 u-text-default u-text-2"></h2>
      </div>
    </section>
    <section class="u-clearfix u-section-2" id="sec-0ca3">
      <div class="u-clearfix u-sheet u-sheet-1">
     ...
     %>  
    	...
    	<table class="table">
            ...
            <tbody id="foodItemDetails">
              ...
              <%-- <c:forEach var="it" items="${foodItemCart}">
              
              <c:set var="sub" value="${it.foodItemTotal}"/>
              <% for int i = 0;   session.getAttribute("foodItemCart").%>
                ...
                <tr>
                    <td>
                        <div class="product-item">
                            <a class="product-thumb" href="#"><img src="<spring:url value="/resources/siteImage/${it.foodItem.image}"/>"  alt="Product"></a>
                            <div class="product-info">
                                <h4 class="product-title"><a href="#">${it.foodItem.name}</a></h4><span>${it.foodItem.description}</span>
                            </div>
                        </div>
                    </td>
        ...
        <table class="table" id="promoTable">
            ...
            <tbody>
              ...
              <c:forEach var="it" items="${promoCart}">
                            
                <tr>
                    <td>
                        <div class="product-item">
                            <a class="product-thumb" href="#"><img src="<spring:url value="/resources/siteImage/${it.promo.image}"/>" alt="Product"></a>
                            <div class="product-info">
                                <h4 class="product-title"><a href="#">${it.promo.name}</a></h4><span>${it.promo.description}</span>
                            </div>
                        </div>
                    </td>
                    <td class="text-center">
...
c0-7.4,3.4-18.8,18.8-18.8h13.8v15.4H75.5z"></path></svg></span>
	...
	<script type="text/javascript" src="<spring:url value="/resources/libs/jquery.counterup/jquery.counterup.min.js"/>"></script>
        ...
        <!-- jquery step -->
        <script type="text/javascript" src="<spring:url value="/resources/libs/jquery-steps/build/jquery.steps.min.js"/>"></script>

        <!-- form wizard init -->
        <script type="text/javascript" src="<spring:url value="/resources/js/pages/form-wizard.init.js"/>"></script>
