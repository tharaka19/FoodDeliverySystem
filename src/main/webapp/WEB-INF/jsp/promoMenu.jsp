...
<script>
	...
	function getActivePromo() {
		...
		var data = "";
				...
				$.ajax({
						type : "GET",
						url :"PromoMenu/getActivePrmomo/"+ status,
	...
	function getOnePromo(id){
		...
		$.ajax({
			type : "POST",
			url : "PromoMenu/getOnePromoDetails",
			dataType : 'json',
			data : {
			...
			success : function(response) {
				...
				for (i = 0; i < data.length; i++) {
					...
					$("#foodItemName").append('<li><i class="mdi mdi-circle-medium me-1 align-middle"></i>'+ data[i].foodItem.name +'</li>');
				    $("#foodQuantity").append('<li>'+ data[i].foodQuantity +'</li>');
				    $("#foodImage").append('<li class="list-inline-item">'
						                   + '<a href="#" class="active" data-bs-toggle="tooltip" data-bs-placement="top" title="'+ data[i].foodItem.name +'">'
						                   + '<div class="product-color-item"> <img src="<spring:url value="/resources/siteImage/' + data[i].foodItem.image + '"/>" alt="" class="avatar-md"> </div>'
						                   + '</a> </li>');	
				}
...
<div class="container" >
    ...
    <!-- promo description -->
     ...
     <div class="row" id="promoDescription">
										<div class="col-xl-5">
												...
												<div class="row">
													...
													<div class="col-9">
														<div class="tab-content position-relative" id="v-pills-tabContent">
															...
															<div class="tab-pane fade show active" id="promoImage" role="tabpanel">
														...
														<div class="row text-center mt-2">
														    ...
														    <div class="col-sm-6" id="promoBTN">
											...
											<div id="promoDetails">
												...
												<div>
													<div class="row">
														<div class="col-md-6">
															<div class="mt-3">
																<h5 class="font-size-14">Food Item :</h5>
																<ul class="list-unstyled product-desc-list text-muted" id="foodItemName">
														...
														<div class="col-md-6">
															<div class="mt-3">
																<h5 class="font-size-14">Quantity :</h5>
																<ul class="list-unstyled product-desc-list text-muted" id="foodQuantity">
													...
													<div class="row">
														<div class="col-lg-7 col-sm-8">
															<div class="product-desc-color mt-3">
																<h5 class="font-size-14">Food Item :</h5>
																<ul class="list-inline" id="foodImage">
