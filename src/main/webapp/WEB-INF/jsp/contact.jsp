...
<html style="font-size: 16px;">
  <head>
    ...
    <link rel="stylesheet" href="resources/admin/css/Contact.css" media="screen">
  ...
  <body class="u-body u-overlap"><header class=" u-clearfix u-header u-section-row-container" id="sec-8947"><div class="u-section-rows" style="margin-bottom: 0px;">
    ...
    <section class="u-clearfix u-image u-parallax u-section-1" id="sec-6e79" data-image-width="1280" data-image-height="853">
            ...
            <div class="u-layout-row">
              <div class="u-align-left u-container-style u-layout-cell u-left-cell u-size-22 u-layout-cell-1">
                <div class="u-container-layout u-container-layout-1">
                  <h1 class="u-text u-text-custom-color-2 u-text-default u-text-1"> Contact<br>Us
                  </h1>
                  <h2 class="u-text u-text-custom-color-1 u-text-default u-text-2">HOME / CONTACT</h2>
                </div>
              </div>
    ...
    <section class="u-clearfix u-white u-section-2" id="sec-a3fe">
          ...
          <div class="u-layout" style="">
            <div class="u-layout-row" style="">
              <div class="u-container-style u-layout-cell u-left-cell u-size-20 u-size-60-md u-layout-cell-1">
                <div class="u-container-layout u-container-layout-1">
                  <h3 class="u-text u-text-3">Get in touch</h3><span class="u-icon u-icon-circle u-text-palette-1-base u-icon-1" data-animation-name="tada" data-animation-duration="1000" data-animation-delay="0" data-animation-direction=""><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 128 128" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-535e"></use></svg><svg class="u-svg-content" viewBox="0 0 128 128" id="svg-535e"><g><path d="m107.427 84.289h-30.155a182.929 182.929 0 0 1 -13.272 18.371 182.929 182.929 0 0 1 -13.272-18.371h-30.155l-14.267 37.405h115.388z" fill="#dfeef4"></path><path d="m64 6.31a30.711 30.711 0 0 0 -30.71 30.71c-.18 29.3 30.71 65.64 30.71 65.64s30.89-36.34 30.71-65.64a30.711 30.711 0 0 0 -30.71-30.71zm0 43.74a13.03 13.03 0 1 1 13.03-13.03 13.025 13.025 0 0 1 -13.03 13.03z" fill="#f45858"></path><path d="m110.74 92.96-57.58 20.48-22.44-29.15h20.01a182.752 182.752 0 0 0 13.27 18.37 182.752 182.752 0 0 0 13.27-18.37h30.16z" fill="#f2da30"></path><path d="m29.96 121.694 56.996-20.274 15.604 20.274z" fill="#3ea2e5"></path>
</g></svg></span>
                </div>
              </div>
...
c0-7.4,3.4-18.8,18.8-18.8h13.8v15.4H75.5z"></path></svg></span>
    ...
    <section class="u-clearfix u-grey-light-2 u-typography-custom-page-typography-12--Map u-section-3" id="sec-ac2f">
      <div class="u-expanded u-grey-light-2 u-map">
        <div class="embed-responsive">
          <iframe class="embed-responsive-item" src="//maps.google.com/maps?output=embed&amp;q=Henry%20Bakers%20Mirigama%20Sri%20Lanka&amp;t=m" data-map=""></iframe>
        </div>
      </div>
    </section>
