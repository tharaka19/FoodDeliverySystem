...
<head>
	...
	function calculateExpenditure(){
		...
		$('input[name="income"]').val( $('input[name="sales"]').val() - $('input[name="expenditure"]').val() )
		
	}

	function saveIncome(){

		if($('input[name="sales"]').val() == "" || $('input[name="expenditure"]').val() == "" || $('input[name="income"]').val() == ""){
			//alert("faild");
		}else{
					 ...
					 data = response
						...
						for (i = 0; i < data.length; i++) {
								...
								.append(
										'<tr class="tr">'
										        + '<td>' + data[i].id + '</td>'
										        + '<td>Rs ' + data[i].sales + '.00</td>'
										        + '<td>Rs ' + data[i].expenditure + '.00</td>'
										        + '<td>Rs ' + data[i].income + '.00</td>'
										        + '<td>' + data[i].incomeDate + '</td>'
										        + '<td>' + data[i].actionDate + '</td>'
										        + '<td>  <input type="button" class="btn btn-outline-warning waves-effect waves-light" onclick="editIncome('+ data[i].id + ')" data-toggle="modal" data-target="#cart" value="Edit"></input></td>'
										        + '<td>  <input type="button" class="btn btn-outline-danger waves-effect waves-light" onclick="deleteIncome(' + data[i].id + ')" value="Delete"></input></td>'
										        + '</tr>');
	...
	function editIncome(id) {
		...
		$('#idfield').show();
		$('#saveIncomeBtn').hide();
		$('#updateIncomeBtn').show();
		
		$.ajax({
			type : "GET",
			url : "Income/getAllIncome/" + id,
			dataType : 'json',
			success : function(response) {
				
				$("#id").val(response.id),
				$('input[name="sales"]').val(response.sales),
				$('input[name="expenditure"]').val(response.expenditure),
				$('input[name="income"]').val(response.income)
								...
								<div class="card">
										...
										<div class="p-4">
											<div class="d-flex align-items-center">
												...
												<div class="flex-grow-1 overflow-hidden">
													<h5 class="font-size-16 mb-1">Add Today Income</h5>
									...
									<div id="addproduct-billinginfo-collapse" class="collapse show" data-bs-parent="#addproduct-accordion">
										<div class="p-4 border-top">
											<button type="button" class="btn btn-success waves-effect waves-light mb-3" data-toggle="modal" data-target="#cart" onclick="addNewCategoryBtn()"><i class="mdi mdi-plus me-1"></i> Add Today Income</button>
	  										...
	  										<form id="categoryForm" name="categoryform" class="needs-validation" novalidate>
												<div class="row">
														...
														<div class="row">
															...
															<div class="col">
																<div class="mb-3">
																	<label class="form-label" for="validationCustom01">Sales</label>
																	<div class="input-group mb-3">
																	  <div class="input-group-prepend">
																		<span class="input-group-text">Rs:</span>
																	  </div>
		                                                            <input id="input-currency" class="form-control input-mask text-start" data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'digits': 2, 'digitsOptional': false, 'prefix': ' ', 'placeholder': '0'" name="sales" id="sales" readonly="readonly" required>
																	<div class="invalid-feedback">
																		Please provide a valid Sales.
																	</div>
																	</div>
																</div>
															</div>
														...
														<div class="row">
															...
															<div class="col">
																<div class="mb-3">
																	<label class="form-label" for="validationCustom02">Expenditure</label>
																	<div class="input-group mb-3">
																	  <div class="input-group-prepend">
																		<span class="input-group-text">Rs:</span>
																	  </div>
		                                                            <input id="input-currency" class="form-control input-mask text-start" data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'digits': 2, 'digitsOptional': false, 'prefix': ' ', 'placeholder': '0'" name="expenditure" id="expenditure" required onkeyup="calculateExpenditure()"> 
																	<div class="invalid-feedback">
																		Please provide a valid Expenditure.
																	</div>
																	</div>
																</div>
															</div>
														...
														<div class="row">
															...
															<div class="col">
																<div class="mb-3">
																	<label class="form-label" for="validationCustom03">Income</label>
																	<div class="input-group mb-3">
																	  <div class="input-group-prepend">
																		<span class="input-group-text">Rs:</span>
																	  </div>
		                                                            <input id="input-currency" class="form-control input-mask text-start" data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'digits': 2, 'digitsOptional': false, 'prefix': ' ', 'placeholder': '0'" name="income" id="income" readonly="readonly" required>
																	<div class="invalid-feedback">
														...
														<div class="row">
															...
															<div class="col text-end">
																	<button class="btn btn-success" type="submit" id="saveIncomeBtn" onclick="saveIncome()">Save</button>
																	<button class="btn btn-success" type="submit" id="updateIncomeBtn" onclick="updateIncome()">Update</button>
									...
									<a href="<spring:url value="#addproduct-metadata-collapse"/>" class="text-dark collapsed" data-bs-toggle="collapse" aria-haspopup="true" aria-expanded="false" aria-haspopup="true" aria-controls="addproduct-metadata-collapse">
										<div class="p-4">
											<div class="d-flex align-items-center">
												...
												<div class="flex-grow-1 overflow-hidden">
													<h5 class="font-size-16 mb-1">Income Info</h5>
